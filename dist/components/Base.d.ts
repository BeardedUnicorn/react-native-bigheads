...
export declare const Base: ({ eyes: Eyes, eyebrows: Eyebrows, mouth: Mouth, hair, facialHair: FacialHair, clothing, accessory: Accessory, graphic: Graphic, hat, body, hairColor, clothingColor, bgShape, bgColor, lipColor, hatColor, showBackground, lashes, size, containerStyles, containerProps, svgRef, ...rest }: BaseProps) => React.JSX.Element;
export {};
