...
export const TinyGlasses = () => {
  ...
  return (
    <>
      <Circle cx="382.91" cy="594.66" r="33.84" fill={colors.white} opacity={0.2} />
      <Path
      ...
      <Path
        ...
        fill={colors.white}
      />
      <Circle cx="615.2" cy="594.66" r="33.84" fill={colors.white} opacity={0.2} />
      <Path
      ...
      <Path
        ...
        fill={colors.white}
      />
      <Path d="M612.7,578a1.94,1.94,0,0,1-3.8.16c0-1.5.5-2,1.92-2A1.88,1.88,0,0,1,612.7,578Z" fill={colors.white} />
      <Path
